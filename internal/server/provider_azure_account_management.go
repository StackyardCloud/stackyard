...
func (s *Server) handleAzureAccountManagementRouter(w http.ResponseWriter, r *http.Request) bool {
	...
	if !azureIsAccountManagementPath(segments) {
		return false
	}
	...
	if !azureAccountManagementAllowedMethod(r.Method) {
		return false
	}
...
func azureIsAccountManagementPath(segments []string) bool {
...
func azureAccountManagementAllowedMethod(method string) bool {
	switch method {
