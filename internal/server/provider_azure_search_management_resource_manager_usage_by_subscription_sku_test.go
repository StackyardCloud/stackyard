...
func TestAzureSearchManagementResourceManagerUsageBySubscriptionSKURoutesReturnNotImplemented(t *testing.T) {
	t.Parallel()
	...
	path := "/azure/subscriptions/00000000-0000-0000-0000-000000000000/providers/Microsoft.Search/locations/eastus/usages/basic?api-version=2025-05-01"
