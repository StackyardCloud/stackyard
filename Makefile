...
AWS_PR_SMOKE_ENDPOINTS ?= sqs.CreateQueue,sqs.GetQueueAttributes,sqs.SendMessage,sqs.ReceiveMessage,sqs.DeleteMessage,dynamodb.CreateTable,dynamodb.PutItem,dynamodb.GetItem,dynamodb.Query,dynamodb.DeleteTable,ecr.CreateRepository,ecr.DescribeRepositories,ecr.DeleteRepository,lambda.CreateFunction,lambda.Invoke,lambda.DeleteFunction,sns.CreateTopic,sns.ListTopics,s3.CreateBucket,sts.GetCallerIdentity,ses.CreateConfigurationSet,athena.ListWorkGroups,bedrock.CreateGuardrail,cloudfront.CreateCachePolicy,ec2.AllocateAddress,ecs.ListClusters,eks.CreateCluster,elasticache.CreateCacheParameterGroup,elasticloadbalancing.CreateTargetGroup,eventbridge.CreateEventBus,iam.CreateGroup,kinesis.CreateStream,kms.CreateKey,neptune.CreateDBParameterGroup,opensearch.CreateDomain,rds.CreateDbParameterGroup,redshift.DescribeClusters,route53.CreateHostedZone,wafv2.CreateIPSet
