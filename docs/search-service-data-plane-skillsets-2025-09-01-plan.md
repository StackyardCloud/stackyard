# Azure Search Service - Data Plane - Skillsets (`search-service-data-plane-skillsets-2025-09-01`) Staged Plan

## Objective

Emulate Azure Search Service Data Plane Skillsets (`2025-09-01`) with deterministic local behavior for skillset lifecycle and listing workflows.

Primary references:
- `https://learn.microsoft.com/en-us/rest/api/searchservice/skillsets?view=rest-searchservice-2025-09-01`
- `https://learn.microsoft.com/en-us/rest/api/searchservice/skillsets/create?view=rest-searchservice-2025-09-01`
- `https://learn.microsoft.com/en-us/rest/api/searchservice/skillsets/create-or-update?view=rest-searchservice-2025-09-01`
- `https://learn.microsoft.com/en-us/rest/api/searchservice/skillsets/delete?view=rest-searchservice-2025-09-01`
- `https://learn.microsoft.com/en-us/rest/api/searchservice/skillsets/get?view=rest-searchservice-2025-09-01`
...
- Do not emulate full cognitive skill execution/runtime semantics in this phase.

## Route Envelope

Stackyard route envelope for this service:
- `/azure/skillsets`
- `/azure/skillsets('{skillsetName}')`
...
Skillsets operations documented for this API version:
...
- Add dedicated Azure Search Skillsets router surface.
- Recognize skillset collection and named-resource routes under `/azure/skillsets*`.
...
- Validate route identifiers (`skillsetName`) and conditional headers (`If-Match`, `If-None-Match`) where applicable.
...
## Stage 2: Deterministic Skillset CRUD Fixtures

- Implement deterministic create/get/list/update/delete skillset fixtures with stable ETag behavior.
...
- Add Azure Go SDK style example in `examples/azure/search-service/search-service-data-plane-skillsets-2025-09-01`.
